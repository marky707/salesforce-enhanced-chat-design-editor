...
3. The long-form equivalent, if you prefer a sentence: *"Run the workflow for review ID `<ID>` from its current stage, complete every eligible automatic transition, preserve prior rounds, and stop at the next required human action."*
